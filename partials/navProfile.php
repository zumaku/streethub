        ...
        echo'<div class="container">';
            echo'<ul>';
                echo'<li class="' . $li1 . '">';
                    ...
                    echo'<a href="magazine_ujicoba.php#navProfile">Bingkai</a>';
                    echo'<span class="underline"></span>';
                echo'</li>';
                echo'<li class="' . $li2 . '">';
                    // echo'<a href="gallery.php#navProfile">Galeri</a>';
                    echo'<a href="gallery_ujicoba.php#navProfile">Galeri</a>';
                    echo'<span class="underline"></span>';
                echo'</li>';
                echo'<li class="' . $li3 . '">';
                    // echo'<a href="aboutme.php#navProfile">Tentangku</a>';
                    echo'<a href="aboutme_ujicoba.php#navProfile">Tentangku</a>';
                    echo'<span class="underline"></span>';
                echo'</li>';
            echo'</ul>';
        echo'</div>';
