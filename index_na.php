        ...
        <div class="container">
            ...
            <div class="slider">
                ...
                <div class="cards">
                    ...
                    <a href="#produkSec" class="card dnone" style="background-image: url(img/home/filter.png)">
                        <div class="icon" style="background-image: url(img/icon/filterCard.png)"></div>
                        <h1>Filter</h1>
                    </a>
                    <a href="#produkSec" class="card dnone" style="background-image: url(img/home/tripod.png)">
                        <div class="icon" style="background-image: url(img/icon/monopodCard.png)"></div>
                        <h1>Treepod</h1>
                    </a>
                    <a href="#produkSec" class="card dnone" style="background-image: url(img/home/tas.png)">
                        <div class="icon" style="background-image: url(img/icon/bagCard.png)"></div>
                        <h1>Tas</h1>
                    </a>
                    <a href="#produkSec" class="card dnone" style="background-image: url(img/home/baju.png)">
                        <div class="icon" style="background-image: url(img/icon/kaosCard.png)"></div>
                        <h1>Shirt</h1>
                    </a>
                </div>
